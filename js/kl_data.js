var EVENTS = [
  ...
  /* ── 1961 ── */
  {
    ...
    markers:[
      ...
      { lat:29.559, lng:-95.089, label:'Houston JSC · Mission Control',  desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',         col:'#00d4ff', type:'c' },
  ...
  /* ── 1962 ── */
  {
    ...
    markers:[
      ...
      { lat:29.559, lng:-95.089, label:'Houston · Mission Control',     desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby industrial industry and universities', col:'#00d4ff', type:'c' },
  ...
  /* ── 1965 ── */
  {
    ...
    markers:[
      ...
      { lat:29.559, lng:-95.089, label:'Houston · Mission Control',      desc:"Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry",  col:'#00d4ff', type:'c' },
  ...
  /* ── 1969 ── */
  {
    ...
    markers:[
      ...
      { lat:29.559, lng:-95.089, label:'Houston · Mission Control',      desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry', col:'#ffca28', type:'c' },
  ...
  /* ── 1981 ── */
  {
    ...
    markers:[
      ...
      { lat:29.559, lng:-95.089, label:'Houston JSC · Mission Control',  desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',       col:'#00d4ff', type:'c' },
      { lat:30.390, lng:-89.090, label:'Stennis SC · Mississippi',       desc:'Advantage: Waterway transport access | Massive buffer zone to protect nearby communities from rocket testing noises and vibrations',        col:'#ffca28', type:'c' },
      { lat:29.978, lng:-90.054, label:'Michoud · New Orleans, LA',      desc:'Advantage: Deep-water port for transportation of rockets',         col:'#00e5a0', type:'c' },
  ...
  /* ── 1998 ── */
  {
    ...
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space Center',         desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry", col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston JSC · ISS Control',   desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry', col:'#00d4ff', type:'c' },
  ...
  /* ── 2022 ── */
  {
    ...
    markers:[
      ...
      { lat:29.559, lng:-95.089, label:'Houston JSC · Artemis Control', desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',         col:'#00d4ff', type:'c' },
      { lat:30.390, lng:-89.090, label:'Stennis SC · Engine Testing',   desc:'Advantage: Waterway transport access | Massive buffer zone to protect nearby communities from rocket testing noises and vibrations',    col:'#ffca28', type:'c' },
      { lat:29.978, lng:-90.054, label:'Michoud · SLS Core Stage',      desc:'Advantage: Deep-water port for transportation of rockets',    col:'#00e5a0', type:'c' },
      { lat:34.631, lng:-86.661, label:'Marshall SFC · Huntsville',     desc:"Advantage: Est. in 1960 within the U.S. Army's Redstone Arsenal (missile facility) | nearby missile and propulsion industry expertise", col:'#ffca28', type:'c' }
    ]
  },
  ...
  /* ── 2024 ── */
  {
    ...
    markers:[
      ...
      { lat:29.559, lng:-95.089, label:'Houston JSC',                   desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',   col:'#00e5a0', type:'c' },
  ...
  /* ── 2026 ── */
  {
    ...
    mapView:'usa-s',
    markers:[
      { lat:28.573, lng:-80.649, label:'KSC · LC-39B — Artemis II',     desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry",              col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston JSC · Crew Training',   desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',    col:'#00d4ff', type:'c' },
      { lat:30.390, lng:-89.090, label:'Stennis · Engine Certification', desc:'Advantage: Waterway transport access | Massive buffer zone to protect nearby communities from rocket testing noises and vibrations',                  col:'#ffca28', type:'c' },
      { lat:34.631, lng:-86.661, label:'Marshall SFC · Huntsville, AL', desc:"Advantage: Est. in 1960 within the U.S. Army's Redstone Arsenal (missile facility) | nearby missile and propulsion industry expertise",                   col:'#00e5a0', type:'c' },
      { lat:29.978, lng:-90.054, label:'Michoud · New Orleans, LA',     desc:'Advantage: Deep-water port for transportation of rockets',                   col:'#00e5a0', type:'c' },
