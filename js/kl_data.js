var EVENTS = [
  ...
  /* ── 1965 ── */
  {
    ...
    desc:"While the Mercury program proved humanity could survive in the unforgiving environment of space, the Gemini program put that survival to the test. Each mission was a wild experiment that tested both rocket and man. Gemini IV launched June 3, 1965 with Ed White and Jim McDivitt. Once in orbit, Ed White floated free outside Gemini IV for 23 glorious minutes over the Pacific Ocean, 100 miles up. He used a small handheld oxygen jet gun to maneuver and called it 'the most comfortable part of the mission.' Flight Director Chris Kraft eventually had to order him back inside. White said re-entering was 'the saddest moment of my life.'",
  ...
  /* ── 1972 ── */
  {
    ...
    locAdv:"Apollo 17 was the only night launch in Apollo history. The Saturn V rocket lit up the sky so brightly it was visible from 500 miles away. Once on the Moon, Cernan, Schmitt, and Evans drove the Lunar Rover a record 22 miles across the Taurus-Littrow Valley, collecting 243 pounds of Moon rocks.",
    dist:238855, distLabel:'238,855 miles — The Moon',
