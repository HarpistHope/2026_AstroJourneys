// Event-Specific Details for each timeline/event node: 

var EVENTS = [

  /* ── 1958 ── */
  {
    year:1958, name:'NASA Is Founded',
    meta:'Washington D.C. · July 29, 1958',
    desc:'President Eisenhower signed the National Aeronautics and Space Act into law, driven by Cold War urgency after Sputnik 1 shocked the world in October 1957. Eight thousand scientists and engineers — inherited from the old National Advisory Committee for Aeronautics (NACA) — immediately began work on the greatest space adventures in human history.',
    fact:"Cold war competition was the impetus for the Space Age, which spanned from 1957 to 1975. NASA was officially created just 11 months after the Soviet Union launched Sputnik 1. Within just 3 years, the US had launched their first astronaut towards the final frontier and the race was on!",
    ...
    locAdv:"NASA's first annual budget was $100 million. Today it is ~$25 billion!",
    ...
    mapView:'usa',
    markers:[
      { lat:38.883, lng:-77.016, label:'NASA HQ · Washington D.C.', desc:'Advantage: Direct Congressional oversight | Proximity to policy makers',       col:'#ff3d21', type:'c' }
    ]
  },

  /* ── 1961 ── */
  {
    year:1961, name:'Freedom-7 — The 1st American in Space',
    meta:'Cape Canaveral, FL · May 5, 1961',
    desc:"Alan Shepard climbed into a capsule barely bigger than a phone booth and rode a Redstone rocket 116 miles into space. His 15-minute flight proved that humans could survive space travel. President Kennedy watched from the White House. A few days later, he declared that America would land on the Moon before the decade was out.",
    fact:"Shepard waited in the capsule for 4 hours due to weather conditions and technical delays. He famously radioed: 'Why don't you fix your little problem and light this candle!' He reached speeds up to 5,134 mph and experienced 5 full minutes of weightlessness.",
    ...
    mapView:'usa-e',
    markers:[
      { lat:28.573, lng:-80.649, label:'Cape Canaveral · LC-5',          desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes)", col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Mission Control',  desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',         col:'#00d4ff', type:'c' },
  ...
  /* ── 1962 ── */
  {
    year:1962, name:'Friendship-7 — The 1st American Orbit',
    meta:'Cape Canaveral, FL · February 20, 1962',
    desc:"John Glenn orbited Earth 3 times in 4 hours 55 minutes. During his journey, a faulty sensor caused a mid-flight scare! It indicated that his heat shield might be loose, posing a potentially fatal defect for reentry. Glenn kept his cool, trusted his training, and splashed down safely.",
    fact:"Glenn orbited at 17,500 mph, crossing 3 continents. He later served 24 years as a U.S. Senator for Ohio. In 1998, at age 77, he flew again aboard Space Shuttle Discovery, making him the oldest person ever in space.",
    dyk:"🌍 In Perth, Australia the 'City of Lights' moment became one of the most beloved stories in spaceflight history. As Glenn orbited over the Australian continent, the entire city of Perth switched on their lights — residents, farms, and even ships in the harbor. Glenn confirmed he could see them clearly from 100 miles up. To this day, Perth still calls itself the 'City of Light.'",
    locAdv:"The Atlas rocket lifted Glenn to orbit at 9:47 AM on February 20, 1962. The rocket's trajectory from Cape Canaveral was precisely calculated to pass over a global network of tracking stations in Bermuda, the Canary Islands, and Australia. Back in Houston, Mission Control managed the life-threatening heat shield alarm.",
    dist:162, distLabel:'162 miles — Earth Orbit',
    photos:['img/Mercury_JohnGlennAtlas6_1962rev.jpg'],
    photoCap:'John Glenn, Friendship 7, February 1962 (NASA)',
    emoji:'🌍',
    mapView:'usa-e',
    markers:[
      { lat:28.573, lng:-80.649, label:'Cape Canaveral · LC-14',        desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes)", col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Mission Control',     desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby industrial industry and universities', col:'#00d4ff', type:'c' },
  ...
  /* ── 1965 ── */
  {
    year:1965, name:'Gemini-IV — The 1st American Spacewalk',
    meta:'Cape Canaveral, FL · June 3, 1965',
    desc:"The Mercury missions proved humanity could survive in the unforgiving environment of space. Now, the Gemini missions put that survival to the test. Each mission was a wild experiment that pushed the limits of both rocket and man. Gemini IV launched on June 3, 1965 with Ed White and Jim McDivitt on board. Once in orbit, Ed White floated freely outside of Gemini IV for 23 glorious minutes over the Pacific Ocean, 100 miles up. He used a small handheld oxygen jet gun to maneuver around, calling it 'the most comfortable part of the mission.' Flight Director Chris Kraft eventually had to order him back inside. White that said re-entering the spacecraft was 'the saddest moment of [his] life.'",
    fact:"White's jet gun ran out of fuel with 10 minutes of scheduled Extravehicular Activity remaining. He had to pull himself back to the capsule via a tether. White would later lose his life in the Apollo I launchpad fire on January 27, 1967, alongside Gus Grissom and Roger Chaffee. Their sacrifice - NASA's first major tragedy - would reshape the safety culture of space exploration forever.",
    dyk:"🧑‍🚀 White's spacewalk was unplanned until 3 days before launch. NASA decided to add the Extravehicular Activity only after Alexei Leonov, a Soviet cosmonaut, sucessfully completed humanity's first spacewalk 10 weeks prior. NASA engineers hastily added a handheld maneuvering unit to Gemini IV's payload - White's jet gun. The photos of White floating freely above Earth would go on to become some of the most iconic images in space history.",
    ...
    photos:['img/Gemini_EdwardWhiteGeminiTitan4_1965rev.jpg'],
    photoCap:'Ed White — 1st American spacewalk, Gemini IV, June 1965 (NASA)',
    emoji:'🧑‍🚀',
    mapView:'usa-e',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center · Launch Complex 19',        desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry", col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Mission Control',      desc:"Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry",  col:'#00d4ff', type:'c' },
  ...
  /* ── 1969 ── */
  {
    ...
    desc:"'The Eagle has landed.' At 4:17 PM EDT on July 20, 1969, Neil Armstrong and Buzz Aldrin touched down on the Moon's surface while Michael Collins stayed in lunar orbit above. With the eyes of the entire world watching, Armstrong stepped onto the lunar surface and famously remarked 'That's one small step for man, one giant leap for mankind.'",
    fact:"The Apollo Guidance Computer had only 64 KB of memory! That's nearly a billion times less than today's average smartphone. During the lunar touchdown, Armstrong manually piloted around a boulder field with only 20 seconds of fuel remaining. Before leaving the Moon's surface, the crew left a plaque reading 'We came in peace for all mankind.'",
    dyk:"🌕 The Apollo 11 lunar module's single ascent engine had just one start switch. If it failed, Armstrong and Aldrin would have been stranded on the Moon with no rescue possible. NASA engineer Don Eyles stayed up for 36 straight hours writing a software patch when a computer alarm triggered during landing, but he fixed it; It worked! Nobody told the astronauts at the time how close they had come to complete disaster.",
    locAdv:"Kennedy Space Center's massive VAB (Vehicle Assembly Building) was built specifically for Saturn V. At 526 feet tall, it's one of the largest buildings on Earth by volume. Its coastal location allowed finished rockets to be floated by barge from the Michoud Assembly Facility in Louisiana.",
    dist:240000, distLabel:'~240,000 miles — The Moon',
    photos:['img/Apollo_Apollo11Aldrin_1969.jpg'],
    photoCap:'Buzz Aldrin on the lunar surface — July 20, 1969 (NASA / Neil Armstrong)',
    emoji:'🌕',
    mapView:'usa-s',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center · Launch Complex 39A', desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry",   col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Mission Control',      desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry', col:'#ffca28', type:'c' },
      { lat:30.390, lng:-89.090, label:'Stennis Space·Center · MS',      desc:'Advantage: Waterway transport access | Massive buffer zone to protect nearby communities from rocket testing noises and vibrations', col:'#00e5a0', type:'c' },
      { lat:29.978, lng:-90.054, label:'Michoud Assembly Facility · New Orleans, LA',      desc:'Advantage: Deep-water port for transportation of rockets', col:'#00e5a0', type:'c' },
  ...
  /* ── 1970 ── */
  {
    ...
    desc:"'Houston, we've had a problem.' An oxygen tank exploded 56 hours into Apollo 13's flight, 200,000 miles from Earth. Commander Jim Lovell, Jack Swigert, and Fred Haise powered down to near-darkness, used the lunar module as a lifeboat, and navigated home by starlight. Mission Control worked for 87 consecutive hours to mitigate disaster. After a harrowing 5 days 22 hours 54 minutes and 41 seconds, the three atronauts splashed down safe and sound.",
    fact:"The crew traveled 248,655 miles from Earth's surface while looping around the far side of the Moon - the farthest humanity ventured from our planet until Artemis II in 2026. It was not a cozy ride. Temperatures dropped to near freezing and the men survived on only 6 oz of water per day.",
    dyk:"🏆 LONG-TIME DISTANCE RECORD: Apollo 13's 248,655-mile record (an incidental achievement of the emergency response trajectory) held strong for 52 years, making it the longest-standing record in spaceflight history. The crew had to manually navigate using Earth and the Moon as reference points, like ancient mariners sailing by the stars, because most of their instruments were off to conserve power. A CO₂ scrubber fix built from a sock, cardboard, and a plastic bag saved their lives.",
    ...
    dist:248655, distLabel:'248,655 mi · ★ MANNED DISTANCE RECORD UNTIL 2026 ★',
    ...
    mapView:'usa-s',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center',           desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry", col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Mission Control',      desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry', col:'#ffca28', type:'c' },
  ...
  /* ── 1972 ── */
  {
    year:1972, name:'Apollo-17 — The Last Footprints on the Moon, For Now',
    meta:'Taurus-Littrow Valley · December 1972',
    desc:"Astronaut Gene Cernan and geologist Harrison Schmitt spent 3 days exploring the lunar surface while Ron Evans orbited above. On December 14, Cernan paused at the ladder, remarking 'As I take these last steps from the surface for some time to come, I believe history will record that America's challenge of today has forged man's destiny of tomorrow.' He climbed in; the hatch closed. A temporary goodbye, with more moon joy to come!",
    ...
    mapView:'usa-s',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center · LC-39A Night Launch',    desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry", col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Mission Control',  desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',                  col:'#00d4ff', type:'c' }
    ]
  },
  ...
  /* ── 1981 ── */
  {
    ...
    photos:['img/Columbia_STS1Launch_1981rev.jpg'],
    photoCap:'Space Shuttle Columbia · STS-1, April 12, 1981 (NASA)',
    emoji:'🛸',
    mapView:'usa-s',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center · LC-39A — Shuttle Launch',  desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry",      col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Mission Control',  desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',       col:'#00d4ff', type:'c' },
      { lat:30.390, lng:-89.090, label:'Stennis Space·Center · Mississippi',       desc:'Advantage: Waterway transport access | Massive buffer zone to protect nearby communities from rocket testing noises and vibrations',        col:'#ffca28', type:'c' },
      { lat:29.978, lng:-90.054, label:'Michoud Assembly Facility · New Orleans, LA',      desc:'Advantage: Deep-water port for transportation of rockets',         col:'#00e5a0', type:'c' },
      { lat:34.631, lng:-86.661, label:'Marshall Space·Flight·Center · Huntsville, AL',  desc:"Advantage: Est. in 1960 within the U.S. Army's Redstone Arsenal (missile facility) | nearby missile and propulsion industry expertise",              col:'#ffca28', type:'c' }
    ]
  },
  ...
  /* ── 1998 ── */
  {
    ...
    photos:['img/ISS_1998.jpg'],
    photoCap:'The International Space Station from Space Shuttle Atlantis (NASA)',
    emoji:'🛰️',
    mapView:'world',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center',         desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry", col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · ISS Control',   desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry', col:'#00d4ff', type:'c' },
      { lat:45.965, lng: 63.305, label:'Baikonur Cosmodrome · Kazakhstan',       desc:"Advantage: Relative low latitude | Surrounding desert allows safety and security | Nearby railway transport for rockets and parts", col:'#ffca28', type:'c' },
      { lat:36.130, lng:138.360, label:'JAXA  · Tsukuba, Japan',       desc:"Advantage: Proximity to Tokyo | Surrounding industry, research institutes, and universities", col:'#00e5a0', type:'c' }
    ]
  },
  ...
  /* ── 2022 ── */
  {
    ...
    fact:"The Space Launch System (SLS) produced 8.8 million pounds of thrust at liftoff, 15% more than Saturn V, the previous record holder. The 322-foot rocket burned through 733,000 gallons of propellant in 8 minutes.",
    ...
    locAdv:"SLS launched from Kennedy Space Center's Pad 39B — the same complex family as Saturn V. Pad 39B was rebuilt specifically for SLS — requiring removal of the Shuttle era lightning towers and installation of a new flame trench drainage system. The mobile launcher tower, standing 380 ft tall, is the tallest structure ever used for a NASA rocket.",
    dist:268553, distLabel:'268,553 miles — Distant Retrograde Orbit, Moon',
    photos:['img/Artemis_ArtemisILaunch_2022rev.jpg'],
    photoCap:'Artemis I night launch · November 16, 2022 · Kennedy Space Center (NASA)',
    emoji:'🌙',
    mapView:'usa-s',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center · LC-39B — Artemis Launch', desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry",         col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Artemis Control', desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',         col:'#00d4ff', type:'c' },
      { lat:30.390, lng:-89.090, label:'Stennis Space·Center · Engine Testing',   desc:'Advantage: Waterway transport access | Massive buffer zone to protect nearby communities from rocket testing noises and vibrations',    col:'#ffca28', type:'c' },
      { lat:29.978, lng:-90.054, label:'Michoud Assembly Facility · SLS Core Stage',      desc:'Advantage: Deep-water port for transportation of rockets',    col:'#00e5a0', type:'c' },
      { lat:34.631, lng:-86.661, label:'Marshall Space·Flight·Center · Huntsville',     desc:"Advantage: Est. in 1960 within the U.S. Army's Redstone Arsenal (missile facility) | nearby missile and propulsion industry expertise", col:'#ffca28', type:'c' }
    ]
  },
  ...
  /* ── 2024 ── */
  {
    ...
    photos:['img/Polaris_PolarisDawnCrew_2026rev.jpg'],
    photoCap:'Polaris Dawn Crew — first commercial spacewalk, September 2024',
    emoji:'⭐',
    mapView:'usa-s',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center · LC-39A — SpaceX Pad',     desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry", col:'#00d4ff', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center',                   desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',   col:'#00e5a0', type:'c' },
  ...
  /* ── 2026 ── */
  {
    ...
    mapView:'usa-s',
    markers:[
      { lat:28.573, lng:-80.649, label:'Kennedy Space·Center · LC-39B — Artemis II',     desc:"Advantage: Over-ocean launch safety | vehicle velocity boost from Earth's rotation (maximized at low latitudes) | moderate climate | nearby supporting industry",              col:'#ff3d21', type:'c' },
      { lat:29.559, lng:-95.089, label:'Houston Johnson·Space·Center · Crew Training',   desc:'Advantage: Access to deep-water transport | Moderate climate | Nearby universities and industrial industry',    col:'#00d4ff', type:'c' },
      { lat:30.390, lng:-89.090, label:'Stennis Space·Center · Engine Certification', desc:'Advantage: Waterway transport access | Massive buffer zone to protect nearby communities from rocket testing noises and vibrations',                  col:'#ffca28', type:'c' },
      { lat:34.631, lng:-86.661, label:'Marshall Space·Flight·Center · Huntsville, AL', desc:"Advantage: Est. in 1960 within the U.S. Army's Redstone Arsenal (missile facility) | nearby missile and propulsion industry expertise",                   col:'#00e5a0', type:'c' },
      { lat:29.978, lng:-90.054, label:'Michoud Assembly Facility · New Orleans, LA',     desc:'Advantage: Deep-water port for transportation of rockets',                   col:'#00e5a0', type:'c' },
...
var NASA_CENTERS = [
  ...
  { lat:34.631, lng:-86.661, name:'Marshall Space Flight Center',  abbr:'MSFC', state:'AL', role:'Propulsion engineering — birthplace of Saturn V and SLS',                  col:'#ffca28' },
  ...
  { lat:38.991, lng:-76.848, name:'Goddard Space Flight Center',   abbr:'GSFC', state:'MD', role:'Earth science, Hubble & James Webb telescope operations',                  col:'#b06fff' },
